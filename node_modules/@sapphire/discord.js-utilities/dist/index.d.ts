 ...
 */
declare type MessagePrompterMessage = ArgumentTypes<PartialTextBasedChannelFields['send']>[0];
...
declare type PaginatedMessageMessageOptionsUnion = MessageOptions | WebhookEditMessageOptions;
/**
