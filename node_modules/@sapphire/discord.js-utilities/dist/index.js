...
__reExport(src_exports, require("@sapphire/discord-utilities"));
...
function actionIsButtonOrMenu(action) {
  return action.type === import_discord2.Constants.MessageComponentTypes.SELECT_MENU || action.style !== "LINK" && action.style !== import_discord2.Constants.MessageButtonStyles.LINK;
}
__name(actionIsButtonOrMenu, "actionIsButtonOrMenu");
function isMessageButtonInteraction(interaction) {
  return interaction.type === import_discord2.Constants.MessageComponentTypes.BUTTON;
}
