 ...
 */
export declare type LoopAction<A, B, E> = Step<A> | Finish<B> | Fail<E>;
/**
 ...
 */
export declare function step<A>(x: A): Step<A>;
/**
 * Creates a Step with null value.
 * @returns A LoopAction.
 */
export declare function step_(): Step<null>;
/**
 * Creates a Finish.
 * @typeparam B - Type of finish results.
 * @param x - Value to use.
 * @returns A LoopAction.
 */
export declare function finish<B>(x: B): Finish<B>;
/**
 * Creates a Fail.
 * @typeparam E - Type of errors.
 * @param x - Value to use.
 * @returns A LoopAction.
 */
export declare function fail<E>(x: E): Fail<E>;
/**
 * Creates a Fail with null value.
 * @returns A LoopAction.
 */
export declare function fail_(): Fail<null>;
